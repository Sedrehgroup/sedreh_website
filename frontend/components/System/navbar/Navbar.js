...
export default function Navbar() {
  ...
  return (
    <div className="w-screen h-20 bg-ED-nav flex flex-row-reverse justify-evenly items-center absolute z-10">
      <div className="flex gap-2">
        ...
        >
          <p> راهنمای سامانه </p>{" "}
          <Image src={message} alt="" className="ml-2" />
        </button>
        <div>
          <RightPopupConnection
            btn={
              <button className="guide bg-black1-rgba text-ED rounded-lg flex justify-center items-center w-28 h-10">
                <p> ارتباط با ما </p>{" "}
                <Image src={device} alt="" className="ml-2" />
              </button>
            }
          />{" "}
        </div>{" "}
      ...
      <div
        ...
        dir="rtl"
      ></div>{" "}
      <Image src={logobl} alt="logo" className="logo" />
    </div>
  );
}
