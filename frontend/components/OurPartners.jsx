...
const OurPartners = () => {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center mt-32 sm:mt-60">
      ...
      {/* shabake hamkaran */}
      <div id="partners"></div>
      <div className="flex bg-ED lg:h-[600px] md:h-[1200px] h-[1400px] justify-center items-center mt-80 -mb-40">
